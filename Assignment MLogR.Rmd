...
```{r}
library(devtools)
install_url('https://cran.r-project.org/src/contrib/Archive/gof/gof_1.0.1.tar.gz')
```

```{r}
install_url('https://cran.r-project.org/src/contrib/Archive/LogisticDx/LogisticDx_0.3.tar.gz')
```
